...
stream, _ := c.TextToSpeech.Tts(ctx, &cambai.CreateStreamTtsRequestPayload{
    ...
    Language:         cambai.CreateStreamTtsRequestPayloadLanguageEnUs,
    VoiceID:          147320,
    SpeechModel:      cambai.CreateStreamTtsRequestPayloadSpeechModelMarsInstruct.Ptr(),
...
<CardGroup cols={2}>
  <Card title="Voice Agents" icon="/images/pipecat-orange.svg" href="/integrations/pipecat">
    Build real-time voice agents with Pipecat
  </Card>
  <Card title="LiveKit Integration" icon="/images/livekit-orange.svg" href="/integrations/livekit">
